...
<head>
    ...
    <link rel="preload" href="<?php echo get_template_directory_uri(); ?>/assets/webfonts/fa-brands-400.woff2" as="font"
        type="font/woff2" crossorigin="anonymous" />
    <link rel="preload" href="<?php echo get_template_directory_uri(); ?>/assets/webfonts/fa-regular-400.woff2"
        as="font" type="font/woff2" crossorigin="anonymous" />
    <link rel="preload" href="<?php echo get_template_directory_uri(); ?>/assets/webfonts/fa-solid-900.woff2" as="font"
        type="font/woff2" crossorigin="anonymous" />
    <link rel="preload" href="<?php echo get_template_directory_uri(); ?>/assets/webfonts/themebase.woff?40uiqo"
    ...
    <div id="page" <?php themebase_page_class();?>>
        ...
        <div id="site-main" class="wrapper">
            ...
            <nav class="container-fluid navbar">
                <div class="<?php echo esc_attr($container); ?> navbar__grid">
                    <div class="row">
                        <?php dynamic_sidebar('sb_navbar'); ?>
                    </div>
                </div>
            </nav>
            <!-- navbar  -->